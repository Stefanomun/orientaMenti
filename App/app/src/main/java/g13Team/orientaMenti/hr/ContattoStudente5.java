...
public class ContattoStudente5 extends MenuHR {
    ImageView logo;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_contatto_studente5);
    ...
    public void indietro(View view){
        Intent intent = new Intent(ContattoStudente5.this, ListaStudentiHR.class);
        startActivity(intent);
    }

    public void contatta(View v) {
        AlertDialog.Builder builder = new AlertDialog.Builder(ContattoStudente5.this);
